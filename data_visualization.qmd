...
**Import Data**
```{r}
setwd("/Users/dhruthi11/Downloads/")
...
**Aggregate Statistic**
Histogram of the Distributed Aggregate Statistics
```{r}
...
**Predictor Variables**
Number of Extreme Wind Events by Event Type
```{r}
...
**Variables in Aggregate Statistic**
Crop Damage
```{r}
